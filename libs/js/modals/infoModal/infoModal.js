export const infoModal = () => {
  return `<div class="modal-dialog enterSlowlyLeft animated ml-auto info-modal" role="document">
            <div class="modal-content info-modal">
              <div map-modal-header info-modal>
                <button id="close-map" style="padding: 10px; margin-right: 0px" type="button" class="close" data-dismiss="modal" aria-label="Close">${closeIcon}</button>
              </div>
            </div>
          </div>`;
};
...
//                  <button id="close-map" style="padding: 10px; margin-right: 30px" type="button" class="close" data-dismiss="modal" aria-label="Close">
